...
VALUES (gen_random_uuid(), (SELECT id FROM persons WHERE id_number = 'system'), 'system', '$2a$10$kPSZciJ4XMVo1PjtKbmtA.3XeglUyfB.KhCMuXwqgCX17qluEhfEa', 'System', 'RESET', now(), 'system', 1);
