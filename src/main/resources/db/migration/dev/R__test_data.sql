...
VALUES (gen_random_uuid(), (SELECT id FROM persons WHERE id_number = 'system'), 'system', '$2a$10$9guAijSuNzascVb9..5EI.r0cGXXuwHwSDQIgk5NR8VveUpkczdPW', 'System', 'RESET', now(), 'system', 1);

INSERT INTO applications (id, name, code, description, is_active, created_at, created_by, version)
VALUES (gen_random_uuid(), 'UserService', 'USERSERVIC', 'User Service Application', true, now(), 'system', 1);
